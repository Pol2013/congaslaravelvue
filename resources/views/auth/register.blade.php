                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            <label for="id_autorizacion" class="col-md-4 col-form-label text-md-right">{{ __('Identificador') }}</label>
                            ...
                            <div class="col-md-6">
                             <!--   <input id="id_profession" type="number" class="form-control{{ $errors->has('id_profession') ? ' is-invalid' : '' }}" name="id_profession" value="{{ old('id_profession') }}" required autofocus>  -->
                               <select name= 'id_autorizacion' > 
                                <option value=1>RENIEC </option>
                                  <option value=2>SECRETARIA </option>
                                 <option value=3>SISTEMAS </option>
                                
                                  </select>
                                @if ($errors->has('id_autorizacion'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('id_autorizacion') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
