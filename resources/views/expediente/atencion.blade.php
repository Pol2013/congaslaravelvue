...
<div class="container">
 ...
 {!! Form::open(['route' => 'atencion.store', 'method' => 'post', 'novalidate']) !!}
            @csrf
                            
                    <div class="card-header">{{ __('Registrar Atencion') }}</div>
                  ...
                  <div class="form-group">
                      {!! Form::label('id_tiempo', 'Ingrese el tiempo que tardo en atender el documento') !!}
